...
class HardwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hardware" do
    assert_difference('Hardware.count') do
      post hardwares_url, params: { hardware: { serie: @hardware.serie, status: @hardware.status, type_id: @hardware.type_id } }
    end
  ...
  test "should update hardware" do
    patch hardware_url(@hardware), params: { hardware: { serie: @hardware.serie, status: @hardware.status, type_id: @hardware.type_id } }
